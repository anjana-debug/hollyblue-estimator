...
def home(request):
    ...
    return render(request, 'interior/home.html', {'plans': plans})
...
def step2(request):
    ...
    return render(request, 'interior/step2.html', context)
...
def admin_login(request):
    return render(request, 'interior/admin-login.html')


def admin_dashboard(request):
    enquiries = Enquiry.objects.all().order_by('-created_at')
    return render(request, 'interior/admin-dashboard.html', {
        'enquiries': enquiries,
...
def admin_floorplans(request):
    plans = FloorPlan.objects.all()
    return render(request, 'interior/admin-floorplans.html', {'plans': plans})


def admin_kitchen(request):
    items = KitchenItem.objects.all()
    return render(request, 'interior/admin-kitchen.html', {'items': items})


def admin_accessories(request):
    items = KitchenAccessory.objects.all()
    return render(request, 'interior/admin-accessories.html', {'items': items})
...
def admin_modules(request, category):
    ...
    return render(request, 'interior/admin-modules.html', {
        'items': items,
...
def enquiry_invoice(request, id):
    ...
    return render(request, 'interior/invoice.html', context)